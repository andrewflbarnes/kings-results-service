...
public class JdbcRaceDaoTest {
    ...
    public void getRacesAll() throws Exception {
        ...
        when(jdbcTemplate.query(eq(STMT_ALL), any(RaceMapper.class)))
                .thenReturn(races);
    ...
    public void getRacesByLeague() throws Exception {
        ...
        when(jdbcTemplate.query(eq(STMT_LEAG), eq(new Object[] { LEAGUE }), any(RaceMapper.class)))
                .thenReturn(races);
    ...
    public void getRacesByLeagueAndDivision() throws Exception {
        ...
        when(jdbcTemplate.query(eq(STMT_LERO), eq(new Object[] { LEAGUE, ROUND}), any(RaceMapper.class)))
                .thenReturn(races);
