...
public class JdbcIndividualDaoTest {
    ...
    public void getAllIndividuals() throws Exception {
        ...
        when(jdbcTemplate.query(eq(STMT_ALL), any(IndividualMapper.class)))
    ...
    public void getIndividualsByClub() throws Exception {
        ...
        when(jdbcTemplate.query(eq(STMT_CLUB), eq(new Object[] { CLUB }), any(IndividualMapper.class)))
                .thenReturn(individuals);
    ...
    public void getIndividualsByDiscipline() throws Exception {
        ...
        when(jdbcTemplate.query(eq(STMT_DISC), eq(new Object[] { DISCIPLINE }), any(IndividualMapper.class)))
                .thenReturn(individuals);
