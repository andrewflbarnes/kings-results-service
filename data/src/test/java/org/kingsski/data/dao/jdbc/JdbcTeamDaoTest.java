...
public class JdbcTeamDaoTest {
    ...
    public void getTeamsAll() throws Exception {
        ...
        when(jdbcTemplate.query(eq(STMT_ALL), any(Team.TeamMapper.class)))
                .thenReturn(teams);
    ...
    public void getTeamsByLeague() throws Exception {
        ...
        when(jdbcTemplate.query(eq(STMT_LEAG), eq(new Object[] { LEAGUE }), any(Team.TeamMapper.class)))
                .thenReturn(teams);
    ...
    public void getTeamsByLeagueAndDivision() throws Exception {
        ...
        when(jdbcTemplate.query(eq(STMT_LEDI), eq(new Object[] { LEAGUE, DIVISION }), any(Team.TeamMapper.class)))
                .thenReturn(teams);
